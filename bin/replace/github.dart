...
void main(List<String> args) async {
  ...
  File fileComand = File(join(Directory.current.path, "gh_push.sh"));
  List<String> paths = [];

  await fileComand.writeAsString("s");
...
git init
git branch -M main
git remote add origin https://github.com/freeyaauerincatherine/freeyaauerincatherine_bot_app
git remote set-url --push origin https://freeyaauerincatherine:{main_github_token}@github.com/freeyaauerincatherine/freeyaauerincatherine_bot_app
...
"""
  ...
  for (var i = 0; i < rawPaths.length; i++) {
    if (basename(rawPaths[i]).trim() == "gh_push.sh") {
      continue;
    }
...
"""
  ...
  commandGithub += "\n";
  await fileComand.writeAsString(commandGithub);
  print("FINISHED");
}
